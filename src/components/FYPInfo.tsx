...
export function FYPInfo() {
  return <section className="py-24 bg-[#FFFFFF] dark:bg-[#000000] transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <FadeIn className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#F5F5F5] dark:bg-[#1A1A1A] mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <FadeIn delay={0.1}>
            <div className="p-6">
              <Code className="w-8 h-8 text-[#000000] dark:text-[#FFFFFF] mx-auto mb-4" />
          ...
          <FadeIn delay={0.2}>
            <div className="p-6">
              <Lightbulb className="w-8 h-8 text-[#000000] dark:text-[#FFFFFF] mx-auto mb-4" />
              <h3 className="font-bold text-[#000000] dark:text-[#FFFFFF] mb-2">Innovation</h3>
              <p className="text-sm text-[#666666] dark:text-[#999999]">
          ...
          <FadeIn delay={0.3}>
            <div className="p-6">
              <BookOpen className="w-8 h-8 text-[#000000] dark:text-[#FFFFFF] mx-auto mb-4" />
              <h3 className="font-bold text-[#000000] dark:text-[#FFFFFF] mb-2">Research</h3>
              <p className="text-sm text-[#666666] dark:text-[#999999]">
