  ...
  ({
    ...
    return (
      <>
        <div
          className={cn(
            "pointer-events-none absolute -inset-px hidden rounded-[inherit] border border-[#E0E0E0] dark:border-[#333333] opacity-0 transition-opacity",
            glow && "opacity-100",
          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 40% 40%, #000000 5%, #00000000 15%),
                radial-gradient(circle at 60% 60%, #000000 10%, #00000000 20%), 
                radial-gradient(circle at 40% 60%, #000000 10%, #00000000 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #000000 0%,
                  #000000 calc(25% / var(--repeating-conic-gradient-times)),
                  #000000 calc(50% / var(--repeating-conic-gradient-times)), 
                  #000000 calc(75% / var(--repeating-conic-gradient-times)),
